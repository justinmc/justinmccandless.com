...
<a href = "http://www.smartots.com">SmarTots</a>, a startup focused on kids mobile educational software.
When I'm not programming for work I'm usually programming for fun; check out my
<a href="<?= $this->Html->url('/projects/'); ?>">Projects</a>
page.
</p>
<p>

...
function getkind($filename, $cat)
{
   if (strpos($filename, "archive"))		// archive
      return("archive");
   elseif (strpos($filename, "aboutme"))	// aboutme
      return("aboutme");
...
function head ($cat)
{
   ...
   // Stylesheet
   echo '<link rel = stylesheet type = "text/css" href = "http://www.justinmccandless.com/beta/style.css">' . "\n";
   // Title
...
function titlenav($cat)
{
   ...
   echo '      <script language = "JavaScript" type = "text/javascript" src = "http://www.justinmccandless.com/scripts/title' . $out . '.js"></script><!-- random title pic javascript -->' . "\n";
   echo '      <ul class = "nav1">' . "\n";
   echo '      <li><a href = "http://www.justinmccandless.com/index.php">&nbsp;</a>' . "\n";
   echo '      </ul>' . "\n";
   echo '      <ul class = "nav2">' . "\n";
   echo '      <li><a href = "http://www.justinmccandless.com/blog/index.php">&nbsp;</a>' . "\n";
...
function news ($cat)
{
   ...
   echo '      <a href = "http://www.justinmccandless.com/websites/index.php">Websites</a>' . "\n";
...
function content ($type, $cat, $filename)
{
   ...
   elseif ($type == 'aboutme')
   {
      echo '      <h1><u> About Me </u></h1>' . "\n";
      echo '      <img src = "images/me3.jpg" alt = "Me" title = "B&W = Sexy" style = "float: right;">' . "\n";
      echo '      <p>' . "\n";
      echo '      I\'m currently an undergraduate electrical engineering student at the University of' . "\n";	
      echo '      Michigan, class of 2011, though I was born and raised in Las Vegas, Nevada.  Some of my interests' . "\n";
      echo '      include creating more websites than I can handle, playing the bass guitar, and the typical enginerd stuff' . "\n"; 
      echo '      like cars, computers, and video games.  And a lot more.' . "\n";  
      echo '      <br clear="all"><br>' . "\n";
      echo '      Feel free to stalk me at <a href = "mailto: justin@justinmccandless.com"> justin@justinmccandless.com </a> .' . "\n";
      echo '      </p>' . "\n";
   }
   ...
   elseif ($type == 'index')
   {
      ...
      echo '      <img src = "images/me3.jpg" alt = "Me" title = "B&W = Sexy" style = "float: right;">' . "\n";
      echo '      <p>' . "\n";
      echo '       I am Justin McCandless, and welcome to my homepage.  I\'m currently a senior in electrical engineering
                   at the University of Michigan graduating in April 2011.  The main focus of my studies is computer
                   architecture, but I find myself working on projects as diverse as 
      
      
      currently an undergraduate electrical engineering student at the University of
      Michigan, class of 2011, though I was born and raised in Las Vegas, Nevada.  Some of my interests
      include creating more websites than I can handle, playing the bass guitar, and the typical enginerd stuff
      like cars, computers, and video games.  And a lot more.
      <br clear="all"><br>
      Feel free to contact me at <a href = "mailto: justin@justinmccandless.com"> justin@justinmccandless.com </a> .' . "\n";
      echo '      </p>' . "\n";
   }
   ...
   if (($num == 1) || ($type == 'aboutme') || ($type == 'links') || ($type == 'archive') || ($prevnum == 0))
   ...
   if (($num == $rows) || ($type == 'aboutme') || ($type == 'links') || ($type == 'archive') || ($nextnum == 0))
   ...
   if (($type == 'archive') || ($type == 'aboutme') || ($type == 'links'))
      $wyear = date("Y");
   else
